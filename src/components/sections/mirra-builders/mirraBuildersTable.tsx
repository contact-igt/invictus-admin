...
const MirraBuildersTable = ({ searchText, usersData }: PetsTableProps) => {
    ...
    const columns: GridColDef<Pet>[] = [
        ...
        {
            field: 'interest_green_building',
            headerName: 'Interest Green Building',
            flex: 1.5,
            minWidth: 170,
            align: 'center',
            headerAlign: 'center',
...
export default MirraBuildersTable;
