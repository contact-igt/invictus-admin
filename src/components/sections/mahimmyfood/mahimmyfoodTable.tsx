...
import { mahimmyfoodprops } from 'services/mahimmyFood/script';

interface PetsTableProps {
    searchText: string;
    usersData: mahimmyfoodprops[];
}

const MahimmyfoodTable = ({ searchText, usersData }: PetsTableProps) => {
    ...
    const columns: GridColDef<mahimmyfoodprops>[] = [
...
export default MahimmyfoodTable;
